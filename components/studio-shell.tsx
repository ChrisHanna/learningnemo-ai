...
export function StudioShell({stage,onStageChange,children,topId="top",catalogHref="#catalog"}:StudioShellProps){
  return <main>
    <header className="topbar"><a className="brand" href={`#${topId}`}><b>N</b>LearningNeMo<span>.ai</span></a><div className="top-actions"><small><i/>Interview release · {catalog.length} lessons</small><a href={catalogHref}>Explore catalog</a></div></header>
